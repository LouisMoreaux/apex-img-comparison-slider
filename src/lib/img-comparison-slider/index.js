            ...
            t.exports = function(t) {
                ...
                e.i = function(t, i, s) {
                    ...
                    for (var a = 0; a < t.length; a++) {
                        var d = [].concat(t[a]);
                        s && o[d[0]] || (i && (d[2] ? d[2] = "".concat(i, " and ").concat(d[2]) : d[2] = i),
                        e.push(d))
                    }
                }
                ,
    ...
    (()=>{
        ...
        const e = "rendered"
          , s = (t,e)=>{
            ...
            let s, o;
            return "mousedown" === e.type ? (s = e.clientX,
            o = e.clientY) : (s = e.touches[0].clientX,
        ...
        "undefined" != typeof window && !window.customElements.get("img-comparison-slider") && (window.document && (o = document.createElement("template"),
        ...
        window.customElements.define("img-comparison-slider", class extends h {
            constructor() {
                super(),
                ...
                this.onTouchStart = t=>{
                    this.dragByHandle && !s(this.handleElement, t) || (this.touchStartPoint = a(t),
